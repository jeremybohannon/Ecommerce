...
<body>
<% String breadcrumb = "Home > Productlist ";%>
    ...
    <main class="main">
        ...
        <table class="cartTable orderListTable">
            ...
            <c:forEach items="${products}" var="product">
                <tr>
                    <td>
                        <a href="./admin?action=viewProduct&productCode=${product.productCode}">${product.productCode}</a>
                    </td>
        ...
        <div class="cartAndCheckout">
            <a href="./admin?action=addProduct&blank=true">
